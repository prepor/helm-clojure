* helm-clojure
Emacs package based on [[https://github.com/emacs-helm/helm][helm]] and [[https://github.com/clojure-emacs/cider][cider]] aims to explore Clojure's project environment. With helm-clojure you can quickly discover ANY clojure vars (functions, protocols etc.) avaliable in JVM, read it documentation, go to it definition and insert it into a current code by smart way.
** Installation
...
- if namespace had already been required with alias, it will be inserted with the same alias;
- in all other cases you will be offered to choose alias with the help of [[https://github.com/capitaomorte/yasnippet][yasnippet]] (TAB for complete)
** Demo
